...
public class EditBus extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "Bus Name", "Bus No.", "Source", "Destination", "Departure Time", "Price", "Total Seats", "Current Occupancy", "Operation Days", "Total Distance"
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        busno=(String)model.getValueAt(index,1);

        int result=JOptionPane.showConfirmDialog(null,"Caution! You want to EDIT? ","Sure!",JOptionPane.OK_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE);
        if(result==JOptionPane.OK_OPTION)
        {
            ...
            try
            {
                ...
                if(rs.next())
                {
                    ...
                    currOcc=rs.getString("Current_Occupancy");
                    opDays=rs.getString("Operation_Days");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try
        {
            ...
            st=con.createStatement();
            s = "UPDATE bus_detail SET Bus_No='" + t1.getText() +
                    "', Source='" + cb1.getSelectedItem() +
                    "', Destination='" + cb2.getSelectedItem() +
                    "', Time='" + t2.getText() +
                    "', Bus_Name='" + busName +
                    "', Operation_Days='" + opDays +
                    "', Price=" + Integer.parseInt(t5.getText()) +
                    ", Current_Occupancy=" + Integer.parseInt(currOcc) +
                    ", Distance=" + Integer.parseInt(dist) +
                    ", Seats=" + Integer.parseInt(t6.getText()) +
                    " WHERE Bus_No='" + busno + "'";
            st.executeUpdate(s);
            t1.setText("");
            t2.setText("");
