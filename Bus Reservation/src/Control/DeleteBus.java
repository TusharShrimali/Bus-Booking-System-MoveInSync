...
public class DeleteBus extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                new String [] {
                        "Bus_Name", "Bus_No", "Source", "Destination", "Time", "Price", "Seats", "Current_Occupancy", "Operation_Days", "Distance"
                }
        ));
    ...
    int result=JOptionPane.showConfirmDialog(null,"Caution: You sure want to DELETE? ","Sure!",JOptionPane.OK_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE);
